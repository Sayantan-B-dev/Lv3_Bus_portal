...
<main class="page">
    <div class="sec" style="padding-top:40px">
        <div class="sec-head anim-1">
            <div>
                <a href="<?= APP_URL ?>/routes" class="text-muted small text-decoration-none mb-2 d-inline-block">← BACK TO LIST</a>
                <div class="sec-title">Route <?= htmlspecialchars($route['route_number']) ?> — Detail View</div>
                <div class="sec-desc">
        ...
        <div class="tabs anim-3 mt-24">
            ...
            <button class="tab" data-target="tab-schedule">Schedule</button>
            <button class="tab" data-target="tab-api">API Reference</button>
        </div>
        ...
        <div class="route-details-grid anim-4">
            ...
            <!-- FARE TABLE -->
            <div class="fare-table-wrap tab-content" id="tab-fares" style="display:none">
            ...
            <div class="stop-detail-card tab-content" id="tab-schedule" style="display:none">
                <div style="margin-bottom:20px;display:flex;align-items:center;justify-content:space-between">
                    <span style="font-family:var(--font-display);font-size:15px;font-weight:700">Schedule</span>
                </div>
                <p style="color:var(--muted);font-size:14px">First Bus: <?= $route['first_bus_time'] ?></p>
                <p style="color:var(--muted);font-size:14px">Last Bus: <?= $route['last_bus_time'] ?></p>
                <p style="color:var(--muted);font-size:14px">Frequency: Every <?= $route['frequency_mins'] ?> mins</p>
            </div>

            <div class="stop-detail-card tab-content" id="tab-api" style="display:none">
                <div style="margin-bottom:20px;display:flex;align-items:center;justify-content:space-between">
                    <span style="font-family:var(--font-display);font-size:15px;font-weight:700">API Reference</span>
                </div>
                <p style="color:var(--muted);font-size:14px">GET /api/routes/<?= $route['id'] ?></p>
            </div>
